...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DK_LIBRARY_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_HW_NRF_TIMER20, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_HW_NRF_TIMER22, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CACHE_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_30_ASYNC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_30_NRF_TX_BUFFER_SIZE, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_30_NRF_ASYNC_LOW_POWER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_VIRTIO_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_XSI_SINGLE_PROCESS_LOG_LEVEL, 2);
